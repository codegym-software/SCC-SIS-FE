...
const RoleList: React.FC<RoleListProps> = ({ roles, query, onEdit, onDelete, onCreate, onViewDetails }) => {
        ...
        <section className="rounded-2xl border border-gray-200 bg-white">
            ...
            <div className="px-3 py-3 border-b flex items-start gap-2">
                ...
                <div className="ml-auto">
                    ...
                    >
                        <Shield size={16} /> <span>Tạo vai trò mới</span>
                    </button>
                </div>
            </div>
            ...
            <div className="px-3 py-2 border-b text-xs text-gray-500 grid grid-cols-10 gap-3">
                ...
                <div className="col-span-5">Quyền hạn</div>
