          ...
          {actions.map((action, index) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`h-14 w-14 rounded-2xl ${action.color} grid place-items-center text-white group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg`}
                >
