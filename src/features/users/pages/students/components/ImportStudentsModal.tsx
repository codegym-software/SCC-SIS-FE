...
import { importStudentsFromExcel, downloadImportTemplate } from '@/shared/api/students';
...
export default function ImportStudentsModal({ open, onClose, onSuccess }: Props) {
    ...
    const handleDownloadTemplate = async () => {
        ...
        try {
            ...
            success('Tải template thành công', 'File template đã được tải về');
            setDownloadingTemplate(false);
        } catch (err) {
            setDownloadingTemplate(false);
            error('Lỗi tải template', 'Không thể tải file template');
        }
    };
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            ...
                            <ol className="text-sm text-blue-800 space-y-1 list-decimal list-inside">
                                <li>Nhấn nút "Tải template" để tải file mẫu Excel với định dạng chuẩn</li>
                                <li>Điền thông tin học viên vào file (các cột bắt buộc: Họ tên, Email, SĐT)</li>
                                <li>Chọn file đã điền và bấm "Import ngay"</li>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-3">
                                <button
                                    ...
                                    className="flex items-center gap-2 px-4 py-2 text-sm font-medium border border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
