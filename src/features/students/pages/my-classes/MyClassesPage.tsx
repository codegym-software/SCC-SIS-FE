    ...
    if (view === 'list') {
        return (
            <div className="space-y-6 max-w-[1200px] mx-auto">
                ...
                {continueLesson && (
                    <div
                        className="bg-gradient-to-r from-emerald-500 to-teal-500 rounded-xl p-6 text-white shadow-lg cursor-pointer hover:shadow-xl transition-all hover:scale-[1.02]"
                        onClick={() =>
                            navigate(
                                `/my-classes/${continueLesson.classId}/modules/${continueLesson.moduleId}/lessons/${continueLesson.lessonId}`,
                            )
                        }
                    >
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="text-sm text-blue-100 mb-1">Tiếp tục học</div>
                                <h2 className="text-xl font-bold mb-2">{continueLesson.lessonTitle}</h2>
                                <div className="text-sm text-blue-100 mb-1">{continueLesson.moduleName}</div>
                                <div className="text-xs text-blue-200">{continueLesson.className}</div>
                            </div>
                            <button className="flex-shrink-0 px-5 py-2 bg-white text-purple-700 hover:bg-purple-50 rounded-lg font-medium transition border border-purple-200">
                                Tiếp tục
                            </button>
                        </div>
                    </div>
