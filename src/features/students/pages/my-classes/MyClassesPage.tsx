                ...
                {!isCollapsed && (
                    <>
                        {module.isMandatory === false && (
                            <div className="text-xs text-blue-600 mb-2">📌 Môn tự chọn</div>
                        )}
        ...
        if (over && active.id !== over.id) {
            setSortableModules((items) => {
                ...
                if (activeModule && overModule && activeModule.semester !== overModule.semester) {
                    toast.error(
                        `🔒 Không thể di chuyển module giữa các học kỳ! Module thuộc học kỳ ${activeModule.semester} không thể di chuyển sang học kỳ ${overModule.semester}.`,
                    );
                    return items;
                }
                                ...
                                >
                                    ...
                                    <div className="flex items-start justify-between mb-3">
                                        ...
                                        <button
                                            ...
                                            onClick={async (e) => {
                                                e.stopPropagation();
                                                await handleViewClassDetail(cls);
                                            }}
                                        >
                                            <Eye size={16} />
                                        </button>
                                    ...
                                    {/* Description */}
                                    {cls.description && (
                                        <div className="mt-3 text-xs text-gray-600 line-clamp-2">{cls.description}</div>
                                    )}
                                </div>
                            );
                        })
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <button
                                                onClick={() =>
                                                    navigate(
                                                        `/my-classes/${selectedClass.classId}/modules/${m.moduleId}`,
                                                    )
                                                }
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex items-center gap-2 text-xs text-gray-700 bg-gray-100 px-3 py-2 rounded-md border border-gray-400 w-fit">
                            ...
                            <span className="font-semibold">
                                Lưu ý: Môn BẮT BUỘC không được phép sắp xếp (vị trí cố định)
                            </span>
                        </div>
                    </div>
                        ...
                        <div className="space-y-6">
                            {Object.keys(modulesBySemester)
                                ...
                                .map((semester) => {
                                    ...
                                    const startIndex = sortableModules.findIndex(
                                        (m) => m.semester === parseInt(semester),
                                    );
                                            ...
                                            <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-4 py-2 rounded-lg">
                                                <h3 className="font-bold text-base">
                                                    ...
                                                    <span className="ml-2 text-sm font-normal">
                                                        ...
                                                        {semesterModules.length === 1 ? 'module' : 'modules'})
                                                    </span>
                                                </h3>
                                            </div>
                                                ...
                                                >
                                                    <div className="space-y-3 pl-4 border-l-2 border-gray-200 ml-2">
                                                        {semesterModules.map((module, idx) => {
                                                            const globalIndex = sortableModules.findIndex(
                                                        ...
                                                        <div className="bg-white rounded-lg border-2 border-blue-500 p-4 shadow-lg opacity-90">
                                                            <div className="flex items-center gap-3">
                                                                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold text-sm">
                                                                    {sortableModules.findIndex(
                                                                        (m) => m.moduleId.toString() === activeId,
                                                                    ) + 1}
                                                                </div>
                                                                <div className="flex-1">
                                                                    <h4 className="font-semibold text-sm">
                                                                        {
                                                                            sortableModules.find(
                                                                                (m) =>
                                                                                    m.moduleId.toString() === activeId,
                                                                            )?.name
                                                                        }
                                                                    </h4>
                                                                </div>
