...
export default function QuizTakePage() {
    ...
    const handleSubmitQuiz = async () => {
        ...
        if (answeredCount < totalQuestions) {
            if (!confirm(`Bạn chưa trả lời hết các câu hỏi (${answeredCount}/${totalQuestions}). Bạn có chắc muốn nộp bài?`)) {
                return;
            }
        }
                            ...
                            <div className="bg-green-50 rounded-lg p-4 text-center">
                                ...
                                <p className="text-3xl font-bold text-green-900">
                                    {attemptHistory.bestScore 
                                        ? Math.round((attemptHistory.bestScore / quiz.questions.reduce((sum, q) => sum + q.points, 0)) * 100)
                                        : 0}%
                                </p>
                            </div>
                                        ...
                                        <div className="flex justify-between items-start">
                                            <div className="flex-1">
                                                <div className="flex items-center gap-2 mb-2">
                                                    <span className="font-bold text-gray-900">Lần {attemptHistory.attempts.length - index}</span>
                                                ...
                                                {attempt.timeSpentSeconds && (
                                                    <p className="text-sm text-gray-600 mt-1">
                                                        Thời gian: {Math.floor(attempt.timeSpentSeconds / 60)} phút {attempt.timeSpentSeconds % 60} giây
                                                    </p>
                                                )}
                                            </div>
                                            <div className="text-right">
                                                ...
                                                <p className="text-xs text-gray-600 mt-1">
                                                    {attempt.score} / {quiz.questions.reduce((sum, q) => sum + q.points, 0)} điểm
                                                </p>
                                            </div>
                                        </div>
                                        {isCompleted && (
                        ...
                        <div className="bg-white rounded-xl p-8 shadow-sm">
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-6">
                                ...
                                <div className="bg-purple-50 rounded-lg p-4">
                                    ...
                                    <p className="text-2xl font-bold text-purple-900">{quiz.questions?.length || 0}</p>
                                </div>
                                ...
                                <div className="bg-gray-50 rounded-lg p-4 mb-6">
                                    ...
                                    <div className="flex gap-4 text-sm">
                                        ...
                                        <div>
                                            ...
                                            <span className="font-bold text-blue-600">{attemptHistory.attemptsRemaining} lần</span>
                                        </div>
                                    </div>
                                </div>
                            )}
                                            ...
                                            {question.options.map(option => (
                                                ...
                                                >
                                                    <input
                                                        ...
                                                        onChange={() => handleSelectAnswer(question.questionId, option.optionId)}
        ...
        return (
            ...
            <div className="fixed inset-0 bg-gray-50 overflow-y-auto">
                <div className="min-h-screen">
                    ...
                    <div className="max-w-4xl mx-auto px-6 py-8">
                        {/* Score card */}
                        <div className={`rounded-xl p-8 shadow-sm mb-6 text-center ${
                            submitResult.isPassed ? 'bg-green-50 border-2 border-green-200' : 'bg-red-50 border-2 border-red-200'
                        }`}>
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <div className="text-xs text-gray-600">
                                                    Điểm: <span className="font-semibold">{question.isCorrect ? question.points : 0} / {question.points}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="mt-6 flex gap-4">
                            ...
                            {!submitResult.isPassed && attemptHistory && attemptHistory.attempts.length < quiz.maxAttempts && (
                                <button
